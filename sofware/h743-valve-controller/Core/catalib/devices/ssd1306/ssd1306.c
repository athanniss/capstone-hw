...
void ssd1306_WriteCommand(uint8_t byte) {
    ...
    LL_I2C_HandleTransfer(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, LL_I2C_ADDRSLAVE_7BIT, 1, LL_I2C_MODE_AUTOEND, LL_I2C_GENERATE_START_WRITE);

    LL_I2C_TransmitData8(SSD1306_I2C_PORT, byte);
...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size)
 {
    ...
    LL_I2C_HandleTransfer(SSD1306_I2C_PORT, SSD1306_I2C_ADDR, LL_I2C_ADDRSLAVE_7BIT, buff_size + 1, LL_I2C_MODE_AUTOEND, LL_I2C_GENERATE_START_WRITE);

    LL_I2C_TransmitData8(SSD1306_I2C_PORT, 0x40);

    while(!LL_I2C_IsActiveFlag_TXE(SSD1306_I2C_PORT)) {}

    for(cnt = 0; cnt < buff_size; cnt++)
    {
        LL_I2C_TransmitData8(SSD1306_I2C_PORT, buffer[cnt]);
        while(!LL_I2C_IsActiveFlag_TXE(SSD1306_I2C_PORT)) {}
    }
}
